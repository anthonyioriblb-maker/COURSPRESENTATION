...
const slideTitles = [
    ...
    "Définitions de base",
    "Médiane et étendue",
    "1) Exemple : Les plantules de blé",
    "Tableau des données",
    ...
    "4) Fonction SOMME",
    "5) Fonction MOYENNE",
    "6) Fonctions MIN et MAX",
    "III. Probabilité",
    "1) Expérience aléatoire",
    "Exemple expérience aléatoire",
    "2) Issue d'une expérience",
    "3) Probabilité d'un événement",
    "Exemple probabilité",
    "4) Événements impossible et certain",
    "5) Propriété (équiprobabilité)",
    "6) Exemple : La roue",
    "Exemple roue - Calcul",
    "IV. Lien entre probabilité et fréquence",
    "Propriété lien",
    "1) Exemple : 30 répétitions",
    "2) Exemple : 122 800 répétitions",
    "3) Exemple : 393 511 répétitions",
    "Conclusion"
];
