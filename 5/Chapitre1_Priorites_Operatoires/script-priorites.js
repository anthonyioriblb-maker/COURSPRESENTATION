...
// Titres des slides du Chapitre 1
const slideTitles = [
    "Chapitre 1 : Priorités opératoires",                  // Slide 1
    "I. Rappels vocabulaire",                              // Slide 2
    "II. Calculs sans parenthèses",                        // Slide 3
    "III. Calculs avec des parenthèses",                   // Slide 4
    "IV. Division par un nombre décimal",                  // Slide 5
    "V. Distributivité (calcul astucieux)",                // Slide 6
    "VI. Programme de calcul et expression",                // Slide 7
    "VII. Multiples, diviseurs et divisibilité"             // Slide 8
];
