...
const slideTitles = [
    ...
    "II. Divisibilité — 1) Diviseurs et multiples",
    "II. Divisibilité — 2) Critères de divisibilité",
    "II. Divisibilité — 3) Nombres premiers",
    "III. Décomposition en produit de facteurs premiers",
    "IV. Plus Grand Commun Diviseur (PGCD) — Définition et méthode",
    "IV. Plus Grand Commun Diviseur (PGCD) — Application",
    "V. Plus Petit Commun Multiple (PPCM) — Définition et méthode",
    "V. Plus Petit Commun Multiple (PPCM) — Application",
    "VI. Application aux fractions — 1) Fraction irréductible",
    "VI. Application aux fractions — 2) Chocolatier",
    "VI. Application aux fractions — 3) Dallage"
];
