...
const slideTitles = [
    ...
    "I. Qu'est-ce qu'un nombre relatif ? — Les nombres relatifs",
    "I. Distance à zéro",
    "I. Nombres opposés",
    "II. Repérage sur une droite graduée — Droite graduée",
    "III. Comparaison de nombres relatifs — Règle générale",
    "III. Comparaison de nombres de signes différents",
    "III. Comparaison de nombres positifs",
    "III. Comparaison de nombres négatifs",
    "IV. Repérage dans le plan — Repère du plan",
