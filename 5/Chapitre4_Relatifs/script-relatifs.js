...
const slideTitles = [
    ...
    "III. Comparaison de nombres relatifs — 4) Comparaison de nombres négatifs",
    "IV. Repérage dans le plan — 1) Repère du plan",
    "IV. Repérage dans le plan — 2) Coordonnées d'un point"
];
