...
const slideTitles = [
    "Chapitre 11 : Géométrie dans l'espace",                               // Slide 1
    "I. Sphère et boule — 1) Vocabulaire",                                 // Slide 2
    "I. 2) Aire d'une sphère et volume d'une boule",                       // Slide 3
    "I. 3) Section d'une sphère par un plan",                              // Slide 4
    "II. Cubes, pavés, cylindres — 1) Volumes et formules",                // Slide 5
    "II. 2) Sections particulières",                                        // Slide 6
    "III. Pyramide et cône — 1) Volumes et formules",                      // Slide 7
    "III. 2) Section par un plan parallèle à la base",                     // Slide 8
    "IV. Repérage dans l'espace — 1) Repère de l'espace",                  // Slide 9
    "IV. 2) Se repérer sur une sphère",                                    // Slide 10
];
