...
const slideTitles = [
    ...
    "I. 2) Poser une soustraction",
    "I. 3) Poser une multiplication",
    "II. Division euclidienne",
    "II. 1) Poser une division euclidienne",
    "III. Vocabulaire",
    "IV. Critères de divisibilité",
    "V. Division décimale",
    "V. 1) Continuer une division euclidienne",
    "V. 2) Diviser un nombre décimal"
];
...
document.addEventListener('keydown', (e) => {
    ...
    if (document.getElementById('helpOverlay').classList.contains('active')) { if (e.key === 'Escape' || e.key === 'h' || e.key === 'H' || e.key === '?') closeHelp(); return; }
